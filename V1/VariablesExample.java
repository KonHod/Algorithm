public class VariablesExample {
    public static void main(String[] args) {
        // 1.1 ตัวแปรที่จะใช้เก็บค่าของขนาดของเสื้อผ้า ซี่งมีขนาดเป็น s, m หรือ 1
        char clothingSize = 's'; // สามารถเป็น 's', 'm', หรือ '1'
        ...
        final double PI = 3.14159; //ค่า Pi ควรเป็นค่าคงที่
